...
class ReturnItem:
    """
    Attributes:
        id (Union[Unset, str]): The unique identifier of the return
        status (Union[Unset, str]): The status of the return
        order_id (Union[Unset, str]): The unique identifier of the order associated with the return
        ...
        requested_date (Union[Unset, datetime.date]): The date the return was requested
        ...
        amount (Union[Unset, str]): The total amount refunded for the return
        reported_condition (Union[Unset, str]): The condition of the item reported by the customer
        tax_refunded (Union[Unset, str]): The amount of tax refunded for the return
        total_refunded (Union[Unset, str]): The total amount refunded for the return, including tax
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return_item.additional_properties = d
        return return_item
